...
final class ConfigManager {
    ...
    // TODO: Replace with this app's config endpoint.
    var configEndpointURL: URL? = URL(string: "https://vorenachronicle.com/config.php")

    /// Store ID приложения (iOS — с префиксом "id").
    // TODO: Replace with App Store ID, e.g. "id1234567890".
    var storeId: String = "id6784790307"
